...
<div className="relative aspect-video w-full flex-none overflow-hidden rounded-xl">
  <Image
    src="https://images.unsplash.com/photo-1655721532485-0fba33207593?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1548&q=80"
    alt=""
    width={3024}
    height={4032}
