...
export default function Page() {
  ...
  //   };
  return (
    <section className="mx-auto min-h-full w-full max-w-7xl flex-1 scroll-m-20 items-center justify-center px-6 py-12">
      <div className="flex max-w-7xl flex-col items-center gap-8 px-4 lg:flex-row lg:justify-between lg:gap-16 lg:py-0">
        <div>
