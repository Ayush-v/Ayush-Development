  ...
  return (
    <Container className="p-8">
      ...
      <div className="mx-auto mt-9 max-w-md space-y-2 sm:mx-0">
        ...
        <div className="flex items-center justify-between rounded-xl border border-zinc-700 bg-gradient-to-b from-black/10 to-white/10 px-2.5 py-3 dark:bg-zinc-900">
      ...
      <div className="mx-auto mt-9 max-w-md space-y-2 sm:mx-0">
        ...
        <div className="flex items-center space-x-3">
          <button className="flex items-center justify-center rounded-full border border-zinc-800 bg-gradient-to-b from-black/10 to-white/10 p-3 shadow-lg shadow-zinc-800/5 backdrop-blur dark:from-black dark:to-white/10">
